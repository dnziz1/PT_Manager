...
```
cd existing_repo
git remote add origin https://git.cs.kent.ac.uk/dc637/comp6000-2023-ptmanager.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.cs.kent.ac.uk/dc637/comp6000-2023-ptmanager/-/settings/integrations)
